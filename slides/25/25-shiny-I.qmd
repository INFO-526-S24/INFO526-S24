...
```{r message = FALSE}
manager <- read_csv(here::here("slides/25", "data/survey.csv"))
manager
```
...
::: task
Go to the `ae-25` project and code along in `manager-survey/app-1.R`.
:::
