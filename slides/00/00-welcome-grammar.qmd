...
-   Lectures (weekly)
    -   Mondays, 3:30 - 4:45 pm - M Pacheco ILC, RM 130
    -   Wednesdays, 3:30 - 4:45 pm - M Pacheco ILC, RM 130
-   Meeting dates
...
[datavizaz.org](https://www.datavizaz.org/)
:::
...
```{=html}
<iframe width="1000" height="400" src="datavizaz.org" frameborder="1" style="background:white;"></iframe>
```
:::
...
-   Some lab sessions allocated to working on projects, doing peer review, getting feedback from your TA
...
3.  Make sure you can login in to RStudio Cloud and join the organization for INFO 526: [cmgr.oit.duke.edu/containers](https://cmgr.oit.duke.edu/containers)

4.  Complete the *Getting to know you* survey on D2L -- to be posted
