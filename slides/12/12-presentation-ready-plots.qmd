...
Presentations Monday Oct 16 in lecture:
...
We might go over by 10 mins max for lecture. Let me know if this presents a big issue for getting to your next class.
:::
...
#| echo: false
#| message: false
ret_rate <- read_csv(here::here("slides/12", "data", "RetentionRateoverTime.csv")) |> 
  janitor::clean_names()
...
simdata1 <- read_csv(here::here("slides/12", "data", "simdata1.csv")) |>
...
salesStates <- read_csv(here::here("slides/12", "data", "salesStates.csv"))
...
salesStates <- read_csv(here::here("slides/12", "data", "wageDistribution.csv")) |>
  janitor::clean_names() |>
...
-   Presentation:
    -   Pauses
    -   Smaller text
-   Website: `https://vizdata-s23.github.io/ae-12-YOUR_GITHUB_NAME/`
    -   Rendering site
