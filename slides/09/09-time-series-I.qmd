...
-   Project 1 proposal due Monday, 3pm

-   Project 1 presentations -- Monday in class, all team members must be there
...
dch_2022 <- read_csv(here::here("slides/09/", "data/durham-chapel-hill/ad_aqi_tracker_data-2022.csv"))
```
...
dch_2022 <- read_csv(
  here::here("slides/09/", "data/durham-chapel-hill/ad_aqi_tracker_data-2022.csv"),
  na = c(".", "")
)
```
