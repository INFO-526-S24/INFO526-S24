...
-   HW 1 will be posted after class, due next Monday (Sept 11).
...
-   Clone the repo called `ae-03-[YOUR-GITHUB-USERNAME]` and work on the exercises for Part 1.
...
-   Clone the repo called `ae-03-[YOUR-GITHUB-USERNAME]` and work on the exercises for Part 2.
