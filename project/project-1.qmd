...
-   Week 1 of project (week of September 11): Choose a dataset and write up your proposal in `proposal.qmd`.

-   Week 2 of project (week of September 18): Provide peer review to two other teams in the form of issues in their GitHub repos, address the issues left on your team's project repo by closing them with explicit commits. Feel free to get started on your presentation as well.

-   Week 3 of project (week of September 25): Review feedback from me on your proposal and close any remaining issues. Work on your presentation in `presentation.qmd` and write-up in `index.qmd`.

-   Weeks 4-5 of project (week of October 2, 9): Finalize your write-up, presentation, and your project website. Present in class on Monday the following week.

## Due dates

-   Proposals for peer review: due on Wednesday, September 20 at 3:30pm.
-   Revised proposals for teaching team review: due Monday, September 25 at 11:59pm.
-   Write-up and presentation: due Monday, October 16 at the **beginning** of class.
...
```{r, echo=FALSE}
# Create a dataframe
reviewer <- c("Aes-thetics Squad", "DataInk Drinkers", "ggplotGurus", "R-tisans of Visuals", "The Plotting Pandas", "ScatterPlot Sorcerers")
reviewee <- c("The Plotting Pandas", "ggplotGurus", "ScatterPlot Sorcerers", "Aes-thetics Squad", "R-tisans of Visuals", "DataInk Drinkers")

df <- data.frame(reviewer, reviewee)
gt(df) 
```
...
+------------------------------------------------------------------------+--------------------------------------------------+
| [Within team peer evaluation](https://forms.gle/oh8Rjhjx3HnCM54s9)[^6] | 10 pts                                           |
+------------------------------------------------------------------------+--------------------------------------------------+
